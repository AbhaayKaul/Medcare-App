...
const Featurette = () => {
  ...
  return (
    <>
      {/* <Container */}
      <div data-aos="fade-down" className="row featurette margin-featurette box" >
        <div className="col-md-7">
...
>>>>>>> c9185ed24191a5bddd72ce16b132c4568354eaf7
          </p>
        </div>
        <div className="col-md-5">
          <Image src="/images/service-1.png" />
...
=======
      <div data-aos="fade-right" className="row featurette margin-featurette box">
        <div className="col-md-7 order-md-2">
          <h1 className="featurette-heading">
...
=======
      <div data-aos="fade-left" className="row featurette margin-featurette box">
        <div className="col-md-7">
          <h1 className="featurette-heading">
